...
echo "      of them read 8.11, 6.02 and 4.40. Meanwhile the two --local lanes"
echo "      held at 181-183/s every single time, because nothing they do"
echo "      touches the store. cocolog's CLAUDE.md says a slow suite is"
